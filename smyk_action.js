// Script 2: Apply second set of actions (Edit existing files)
...
if (inputFolder != null) {
    ...
    // Define the second set of actions to run
    var actions = [
        { actionSet: "AATK 4-väri", actionName: "2" },  // Replace with your third Action Set name and Action name
        // Add more actions here if needed for the second set
    ];
